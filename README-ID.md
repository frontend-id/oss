# Proyek Sumber Terbuka dari Frontend Indonesia
...
- [Preact + Typescript + Parcel](https://github.com/ywnv/preact-typescript-parcel) oleh [Yoghaswara HN](https://github.com/ywnv) - Proyek awalan untuk Preact + Typescript + ParcelJS - Preact, Typescript, ParcelJS
- [ReasonReact Parcel Starter](https://github.com/ywnv/reason-react-parcel) oleh [Yoghaswara HN](https://github.com/ywnv) - Proyek pemulaan web dengan ReasonReact dan ParcelJS - ReasonML, React, ParcelJS
...
- [html-form-generator](https://github.com/ywnn/html-form-generator) oleh [Yoghaswara HN](https://github.com/ywnn) - Generator Form HTML sederahana mengunakan baris terminal.

...
- [QRious](https://github.com/neocotic/qrious) oleh [neocotic](https://github.com/neocotic) - Library murni Javascript yang di ciptakan untuk pembuatan QR Code menggunakan HTML Canvas - qr, qrcode, qrcode-generator, javascript, neocotic qrious